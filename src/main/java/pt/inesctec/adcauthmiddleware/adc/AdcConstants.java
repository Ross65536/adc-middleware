...
public final class AdcConstants {
  ...
  public static final Set<String> AllUsedFields = Set.of(REPERTOIRE_STUDY_ID_FIELD, REPERTOIRE_STUDY_TITLE_FIELD, REPERTOIRE_REPERTOIRE_ID_FIELD, REARRANGEMENT_REARRANGEMENT_ID_FIELD);
