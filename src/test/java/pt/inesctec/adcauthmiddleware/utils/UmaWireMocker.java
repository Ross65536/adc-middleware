...
public class UmaWireMocker {
  ...
  public static String wireCreateResource(WireMockServer umaMock, Map<String, Object> repertoire, String expectedBearer) {
    var studyId = TestCollections.getString(repertoire, RepertoireConstants.UMA_ID_FIELD);
    var studyTitle = TestCollections.getString(repertoire, RepertoireConstants.STUDY_TITLE_FIELD);
