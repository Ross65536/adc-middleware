...
public class AdcAuthEndpointTests extends TestBase {
    private static final Set<String> RepertoireIdFields = Set.of(RepertoireConstants.UMA_ID_FIELD);
    private static final Set<String> RearrangementIdFields = Set.of(RearrangementConstants.REPERTOIRE_ID_FIELD);
    private static final WireMockServer umaMock = new WireMockRule(options().port(TestConstants.UMA_PORT));
    Set<String> RepertoireStatisticsScopeFields = Set.of(
    ...
    private static final Set<String> RepertoirePublicFields = Set.of(
    ...
    @BeforeAll
    public void init() {
        var searchRequest = ModelFactory.buildAdcFields(
            RepertoireConstants.ID_FIELD,
            RepertoireConstants.UMA_ID_FIELD,
            RepertoireConstants.STUDY_TITLE_FIELD
        );
    ...
    public void singleRearrangementTicket() {
        ...
        var repertoireId =  TestCollections.getString(firstRepertoire, RepertoireConstants.ID_FIELD);
        var rearrangement = ModelFactory.buildRearrangement(repertoireId, rearrangementId);

        WireMocker.wireGetJson(
            backendMock,
            TestConstants.buildAirrPath("rearrangement", rearrangementId),
            200,
        ...
        this.requests.getJsonUmaTicket(
            this.buildMiddlewareUrl("rearrangement", rearrangementId),
            ticket);
    }
